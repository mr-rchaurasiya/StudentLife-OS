...
function DashboardContent() {
  ...
  const handleSelectPhaseFromPalette = (phaseId: string) => {
    const map: Record<string, any> = {
      ...
      'voice-tutor': 'VOICE_TUTOR',
      'concept-graph': 'CONCEPT_GRAPH',
      'quiz-battle': 'QUIZ_BATTLE',
      'document-annotator': 'DOCUMENT_ANNOTATOR',
      'custom-paper': 'CUSTOM_PAPER',
      'focus-garden': 'FOCUS_GARDEN',
      'ai-podcast': 'AI_PODCAST',
      'coding-lab': 'CODE_SANDBOX',
      'rank-predictor': 'RANK_PREDICTOR',
      'virtual-campus': 'VIRTUAL_CAMPUS',
      'slide-generator': 'SLIDE_GENERATOR',
      'mock-interview': 'MOCK_INTERVIEW',
      'notes-marketplace': 'NOTES_MARKETPLACE',
      'circadian-focus': 'CIRCADIAN_FOCUS',
      'exam-trend': 'EXAM_TREND',
      'ai-whiteboard': 'AI_WHITEBOARD',
      'budget': 'STUDENT_FINANCES',
      'student-finances': 'STUDENT_FINANCES',
      'holo-simulations': 'HOLO_SIMULATIONS',
      'skill-passport': 'SKILL_PASSPORT',
      'research-papers': 'ARXIV_SCHOLAR',
      'arxiv-scholar': 'ARXIV_SCHOLAR',
      'thesis-defense': 'SOCRATIC_DEBATE',
      'socratic-debate': 'SOCRATIC_DEBATE',
      'lost-found': 'CAMPUS_EXCHANGE',
      'campus-exchange': 'CAMPUS_EXCHANGE',
      'video-navigator': 'VIDEO_NAVIGATOR',
      'ergonomic-wellness': 'ERGONOMIC_WELLNESS',
      'research-lab': 'RESEARCH_LAB',
      'neural-flow': 'NEURAL_FLOW',
      'meal-planner': 'HOSTEL_NUTRITION',
      'hostel-nutrition': 'HOSTEL_NUTRITION',
      'latex-studio': 'LATEX_STUDIO',
      'campus-events': 'HACKATHON_RADAR',
      'hackathon-radar': 'HACKATHON_RADAR',
      'patent-search': 'PATENT_DRAFTER',
      'patent-drafter': 'PATENT_DRAFTER',
      'faculty-advisory': 'FACULTY_ADVISORY',
      'peer-tutoring': 'TUTOR_BOUNTY',
      'tutor-bounty': 'TUTOR_BOUNTY',
      'campus-printing': 'CAMPUS_PRINTING',
      'alumni': 'ALUMNI_RADAR',
      'alumni-radar': 'ALUMNI_RADAR',
      'study-swarm': 'STUDY_SWARM',
      'campus-incubator': 'CAMPUS_INCUBATOR',
      'campus-transit': 'CAMPUS_TRANSIT',
      'mental-health': 'MENTAL_RESILIENCE',
      'mental-resilience': 'MENTAL_RESILIENCE',
      'quantum-sim': 'QUANTUM_LAB',
      'quantum-lab': 'QUANTUM_LAB',
      'fellowship-drafter': 'FELLOWSHIP_DRAFTER',
      'hackathon-war-room': 'HACKATHON_WAR_ROOM',
      'speed-reader': 'SPEED_READER',
      'academic-integrity': 'ACADEMIC_INTEGRITY',
      'campus-digital-twin': 'CAMPUS_DIGITAL_TWIN',
      'polyglot-translator': 'POLYGLOT_TRANSLATOR',
      'lab-notebook': 'LAB_NOTEBOOK',
      'spaced-rep': 'ANKI_FSRS',
      'anki-fsrs': 'ANKI_FSRS',
      'micro-gigs': 'MICRO_INTERNSHIP',
      'micro-internship': 'MICRO_INTERNSHIP',
      'knowledge-olympiad': 'KNOWLEDGE_OLYMPIAD',
      'kernel-profiler': 'KERNEL_PROFILER',
      'satellite-tracker': 'ASTRODYNAMICS',
      'astrodynamics': 'ASTRODYNAMICS',
      'chemical-retro': 'CHEMICAL_RETRO',
      'scholar-tracker': 'SCHOLAR_TRACKER',
      'study-guild-dao': 'STUDY_GUILD_DAO',
      'crypto-grants': 'STUDY_GUILD_DAO',
      'neuromorphic-snn': 'NEUROMORPHIC_SNN',
      'quantum-qkd': 'QUANTUM_QKD',
      'code-review': 'PAPER_REFEREE',
      'paper-referee': 'PAPER_REFEREE',
      'crispr-sim': 'CRISPR_EDITOR',
      'crispr-editor': 'CRISPR_EDITOR',
      'venture-safe': 'VENTURE_SAFE',
      'crowdfunding': 'VENTURE_SAFE',
      'fusion-plasma': 'FUSION_TOKAMAK',
      'fusion-tokamak': 'FUSION_TOKAMAK',
      'bci-interface': 'BCI_SPELLER',
      'bci-speller': 'BCI_SPELLER',
      'smart-contract': 'LEGAL_ANALYZER',
      'legal-analyzer': 'LEGAL_ANALYZER',
      'exoplanet-photometry': 'EXOPLANET_PHOTOMETRY',
      'carbon-tracker': 'CARBON_MARKET',
      'carbon-market': 'CARBON_MARKET',
      'gravitational-waves': 'GRAVITATIONAL_WAVES',
      'optics-lab': 'GRAVITATIONAL_WAVES',
    ...
    const targetView = map[phaseId] || map[phaseId.toLowerCase()] || 'DASHBOARD';
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '1440px', width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '12px', cursor: 'pointer' }} onClick={() => setActiveView('DASHBOARD')}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.68rem', color: 'var(--text-secondary)', margin: 0 }}>{t('app_subtitle')}</p>
              </div>
            </div>
